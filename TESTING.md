...
* In the final stages of testing, a new warning came up in Chrome Dev tools console which I had not seen at any other stage - `“Error with Permissions-Policy header: Unrecognized feature: ‘interest-cohort’.”` After doing a bit of research on the internet I found it was connected to a header added to all GitHub Pages sites by GitHub- see notice [here](https://github.blog/changelog/2021-04-27-github-pages-permissions-policy-interest-cohort-header-added-to-all-pages-sites/). I understand this is to do with blocking Google FLoC. Since it was something added by GitHub, I was unable to correct this and so this warning has not been resolved by me. 